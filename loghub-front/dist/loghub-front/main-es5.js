...
var LogsComponent = /** @class */ (function () {
    function LogsComponent() {
        ...
        this.rndStream = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(200).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["scan"])(function (a, c) { return a.concat([c]); }, []), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (r) { return r[Math.floor(Math.random() * r.length)]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])());
    ...
    LogsComponent.prototype.connect2database = function () {
        if (!this.dbConnected) {
    ...
    LogsComponent.prototype.connect2kafka = function () {
...
var PublisherWebService = /** @class */ (function () {
    function PublisherWebService(srvUrl) {
        this.srvUrl = srvUrl;
        this.eventSource = null;
        this.subscriber = null;
    }
    PublisherWebService.prototype.getPproducer = function (limit) {
        var _this = this;
        this.logs = [];
        return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (subscriber) {
            try {
                _this.subscriber = subscriber;
                _this.eventSource = new EventSource(_this.srvUrl);
                _this.eventSource.onmessage = function (event) {
                    var log = JSON.parse(event.data);
                    _this.logs.push(new _log__WEBPACK_IMPORTED_MODULE_3__["Log"](log['key'], log['level'], log['record']));
                    _this.subscriber.next(_this.logs);
                };
                _this.eventSource.onerror = function (err) {
                    switch (_this.eventSource.readyState) {
                        case 0:
    ...
    PublisherWebService.prototype.closeEvenerSource = function () {
